...
export enum Title {
    ...
    DragonBallZGIF = "dragon ball z GIF",
    DragonBallZGokuSuperSaiyanGIFByHYPDSH = "Dragon Ball Z Goku Super Saiyan GIF by HYPDSH !",
}
...
export enum Username {
    Bikogroupindonesia = "bikogroupindonesia",
    Empty = "",
...
const typeMap: any = {
    ...
    "Title": [
        ...
        "dragon ball z GIF",
        "Dragon Ball Z Goku Super Saiyan GIF by HYPDSH !",
    ],
    "Type": [
        "gif",
    ],
